...
<head>
  ...
  <title>Waiting One Click-Login</title>
  <meta content="" name="description">
  <meta content="" name="keywords">
...
<body>
<a href=# class="logo" target="_blank"> <img src="assets/img/logo.png" alt=""> </a>
<div class="section">
    <div class="container">
                            ...
                            <div class="card-front">
                                <div class="center-wrap">
                                    <div class="section text-center">
                                        ...
                                        <div class="form-group"> <input type="email" name="logemail" class="form-style" placeholder="Your ID" id="logemail" autocomplete="off"> <i class="input-icon uil uil-at"></i> </div>
                                        <div class="form-group mt-2"> <input type="password" name="logpass" class="form-style" placeholder="Your Password" id="logpass" autocomplete="off"> <i class="input-icon uil uil-lock-alt"></i> </div> <a href="#" class="btn mt-4">로그인</a>
                                        <p class="mb-0 mt-4 text-center"><a href="#0" class="link">한번의 클릭으로 간편한 예약을 즐겨보세요!</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="card-back">
