...
">
  ...
  <nav class="navbar navbar-light custom-navbar">
    <div class="container">
      <img class="img-fluid" src="assets/img/logo.png">		<!--*****로고******-->
        ...
        <div class="row mb-5 align-items-center">
          ...
          <div class="col-md-12 col-lg-6 text-start text-lg-end" data-aos="fade-up" data-aos-delay="100">
            <div id="filters" class="filters">
              ...
              <a href="#" data-filter=".cafe10">카페 top10</a>
              <a href="#" data-filter=".food10">음식점 top10</a>
              <a href="#" data-filter=".cafe">카페 All</a>
              <a href="#" data-filter=".food">음식점 All</a>
            </div>
          </div>
        </div>
        ...
        <div id="portfolio-grid" class="row no-gutter" data-aos="fade-up" data-aos-delay="200">
          <div class="item cafe10 cafe col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.html" class="item-wrap fancybox">
              ...
              <img class="img-fluid" src="assets/img/cafe.jpg">
            </a>
          </div>
          <div class="item cafe col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.html" class="item-wrap fancybox">
              ...
              <img class="img-fluid" src="assets/img/cafe2.jpg">
            </a>
          </div>
          <div class="item cafe10 cafe col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.html" class="item-wrap fancybox">
              ...
              <img class="img-fluid" src="assets/img/cafe3.jpg">
            </a>
          </div>
          <div class="item cafe col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.html" class="item-wrap fancybox">
              ...
              <img class="img-fluid" src="assets/img/cafe4.jpg">
            </a>
          </div>
          <div class="item cafe col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.html" class="item-wrap fancybox">
              ...
              <img class="img-fluid" src="assets/img/cafe5.jpg">
            </a>
          </div>
          <div class="item cafe col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.html" class="item-wrap fancybox">
              ...
              <img class="img-fluid" src="assets/img/cafe6.jpg">
            </a>
          </div>
          <div class="item food10 food col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.html" class="item-wrap fancybox">
              ...
              <img class="img-fluid" src="assets/img/음식.jpg">
            </a>
          </div>
          <div class="item food10 food col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.html" class="item-wrap fancybox">
              ...
              <img class="img-fluid" src="assets/img/음식1.jpg">
            </a>
          </div>
          <div class="item food col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.html" class="item-wrap fancybox">
              ...
              <img class="img-fluid" src="assets/img/음식2.jpg">
            </a>
          </div>
           <div class="item cafe col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.html" class="item-wrap fancybox">
           ...
           <div class="item cafe col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.html" class="item-wrap fancybox">
              ...
              <img class="img-fluid" src="assets/img/음식4.jpg">
            </a>
          </div>
          <div class="item cafe col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.html" class="item-wrap fancybox">
              ...
              <img class="img-fluid" src="assets/img/음식5.jpg">
            </a>
          </div>
        </div>
      </div>
